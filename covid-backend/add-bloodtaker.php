...
if ($result) {
echo '<script>alert("Blood Taker created successfully.")</script>';
  echo "<script>window.location.href='add-bloodtaker.php'</script>";
} 
else {
...
<head>
    ...
    <title>Covid-19 Testing Management System | Add Blood taker</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Add Blood Taker</h1>
<form name="addBloodTaker" method="post">
  <div class="row">
